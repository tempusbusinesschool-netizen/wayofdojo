/**
 * 🥋 WAYOFDOJO — TECHNIQUES AU BOKKEN (SABRE EN BOIS)
 * 
...
export const TECHNIQUES_BOKKEN: TechniqueArme[] = [
  // ==========================================================================
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "shomen_uchi" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "shomen_uchi_zenpo" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "5e_kyu",
    ordre: 2
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "shomen_uchi_kotai" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "4e_kyu",
    ordre: 3
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "shomen_uchi_zenpo_kotai" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "4e_kyu",
    ordre: 4
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "yokomen_uchi_zenpo" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "3e_kyu",
    ordre: 5
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "yokomen_uchi_kotai" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "3e_kyu",
    ordre: 6
  ...
  { 
    ...
    phase1: { attaque: "", deplacement: "yokomen_uchi_zenpo_kotai" }, 
    phase2: { technique: "ken_suburi", direction: null }, 
    phase3: { final: "kamae", type: "suburi" }, 
    niveau: "2e_kyu",
    ordre: 7
...
export const getBokkenByNiveau = (niveau: NiveauGrade): TechniqueArme[] => {
  return TECHNIQUES_BOKKEN.filter(t => t.niveau === niveau);
};

export const getBokkenByType = (type: string): TechniqueArme[] => {
  return TECHNIQUES_BOKKEN.filter(t => t.phase3.type === type);
};
