/**
 * 🏯 DOJO VIRTUEL - Centre d'entraînement interactif
 * 
 * Exercices de développement personnel pour pratiquants adultes
 * Progression Ki et techniques de concentration
 */
...
const DOJO_GAMES = [
  ...
  },
  {
    ...
    tanakaIntro: "La respiration est la clé de tout. Inspirez par le nez, expirez par la bouche.",
    xpReward: 25,
    kiReward: 20,
    unlockLevel: 0,
  ...
  },
  {
    ...
    tanakaIntro: "L'Aïkido nous apprend à ne pas réagir avec colère. Réfléchissez avant de répondre.",
    xpReward: 35,
    kiReward: 30,
    unlockLevel: 0,
  ...
  },
  {
    ...
    tanakaIntro: "En Aïkido, on apprend en observant. Soyez mon reflet parfait !",
    xpReward: 20,
    kiReward: 15,
    unlockLevel: 0,
  ...
  },
  {
    ...
    tanakaIntro: "L'Aïkido a son propre rythme. Ressentez-le et suivez-le !",
    xpReward: 25,
    kiReward: 20,
    unlockLevel: 0,
  ...
  },
  {
    ...
    tanakaIntro: "Le jardin zen apaise l'esprit. Tracez avec soin !",
    xpReward: 20,
    kiReward: 15,
    unlockLevel: 0,
    component: ZenGarden
  ...
  },
  {
    ...
    description: 'Esquive les obstacles et développez vos réflexes !',
    tanakaIntro: "Un aikidoka est vif et précis. Montrez-moi !",
    xpReward: 25,
    kiReward: 20,
    unlockLevel: 0,
  ...
  },
  {
    ...
    tanakaIntro: "Observez bien et reproduisez la séquence !",
    xpReward: 30,
    kiReward: 25,
    unlockLevel: 0,
