...
// ═══════════════════════════════════════════════════════════════════════════════
// DÉFINITION DES 7 VERTUS AVEC GAMIFICATION COMPLÈTE
// ═══════════════════════════════════════════════════════════════════════════════
...
export const VIRTUES_GAMIFICATION = {
  respect: {
    ...
    // Animal gardien qui évolue avec les niveaux
    animal: {
      base: "🦁",
      name: "Lion Noble",
      evolutions: [
...
// ═══════════════════════════════════════════════════════════════════════════════
// TROPHÉES GLOBAUX (débloqués par combinaison de vertus)
// ═══════════════════════════════════════════════════════════════════════════════
...
export const GLOBAL_TROPHIES = [
  {
    id: "first_virtue",
    name: "Première Vertu",
    description: "Tu as débloqué ta première vertu !",
    emoji: "🌟",
  ...
  },
  {
    ...
    description: "Tu as atteint le niveau 2 dans 3 vertus différentes",
    emoji: "🔺",
  ...
  },
  {
    ...
    description: "Tu as commencé à travailler les 7 vertus",
    emoji: "🗺️",
  ...
  },
  {
    ...
    description: "Tu as validé au moins un défi chaque jour pendant 7 jours",
    emoji: "🔥",
  ...
  {
    id: "balanced_ninja",
    name: "Ninja Équilibré",
    description: "Tu as le même niveau dans toutes les vertus",
    emoji: "☯️",
  ...
  },
  {
    ...
    description: "Tu as débloqué 20 badges différents",
    emoji: "🎖️",
    condition: "20_badges",
    xpBonus: 300
  },
  ...
  },
  {
    ...
    description: "Tu as complété 100 défis quotidiens",
    emoji: "⚔️",
  ...
  },
  {
    ...
    description: "Tu as complété 20 défis hebdomadaires",
    emoji: "🏅",
  ...
  },
  {
    ...
    description: "Tu as fait évoluer tous tes animaux gardiens au niveau 3",
    emoji: "🐾",
...
// ═══════════════════════════════════════════════════════════════════════════════
// TITRES SPÉCIAUX (débloqués par accomplissements)
// ═══════════════════════════════════════════════════════════════════════════════
...
export const SPECIAL_TITLES = [
  ...
  { id: "harmony_ninja", title: "Ninja de l'Harmonie", condition: "all_level_3", emoji: "☯️" },
  { id: "virtue_sage", title: "Sage des Vertus", condition: "all_level_4", emoji: "🧙" },
  { id: "enlightened", title: "Éveillé", condition: "all_level_5", emoji: "✨" }
];
...
/**
 * Calcule le niveau actuel basé sur les XP
 */
...
/**
 * Récupère l'évolution de l'animal pour un niveau donné
 */
...
/**
 * Récupère le titre spécial basé sur le total XP
 */
export const getSpecialTitle = (totalXp, virtueXpMap) => {
  // Vérifier d'abord les conditions de niveau
