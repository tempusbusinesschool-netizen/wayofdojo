...
import { X, Scale, FileText, Shield, CreditCard, RefreshCw, AlertTriangle } from "lucide-react";
import LegalHeader from "./LegalHeader";
import LegalFooter from "./LegalFooter";

/**
 * CGVPage - Conditions Générales de Vente Complètes
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] bg-slate-900 border-slate-700 text-slate-300 p-0">
        ...
        <ScrollArea className="h-[85vh] p-8">
          ...
          <div className="space-y-8 text-sm leading-relaxed">
            <p className="text-slate-400 italic">Dernière mise à jour : {lastUpdate}</p>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-slate-800 p-4 rounded-lg ml-4">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc ml-8 space-y-1">
                  ...
                  <li>Un assistant vocal pédagogique (Maître Tanaka)</li>
                  <li>Des outils de gestion pour les clubs (offre Club d'Aikido)</li>
                </ul>
                <p>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-amber-900/20 border border-amber-500/30 p-4 rounded-lg">
                  <h3 className="font-semibold text-amber-400 mb-2">🥷 Licence Utilisateur Unique</h3>
                  <ul className="space-y-1 text-sm">
                    ...
                    <li>• Période d'essai : <strong>90 jours gratuits</strong> (avec enregistrement de carte bancaire)</li>
                    <li>• <strong>Sans engagement</strong>, résiliable à tout moment</li>
                  </ul>
                </div>

                <div className="bg-cyan-900/20 border border-cyan-500/30 p-4 rounded-lg mt-4">
                  <h3 className="font-semibold text-cyan-400 mb-2">🏯 Licence Club d'Aikido</h3>
                  <ul className="space-y-1 text-sm">
                    <li>• Club {"<"} 30 adhérents : <strong>19,90 € TTC / mois</strong></li>
                    <li>• Club 30-100 adhérents : <strong>29,90 € TTC / mois</strong></li>
                    <li>• Club {">"} 100 adhérents : <strong>Sur devis personnalisé</strong></li>
                    <li>• Période d'essai : <strong>10 jours gratuits</strong></li>
                  </ul>
                  <p className="text-xs text-slate-400 mt-2">
                    Inclus : Accès complet à l'application, Parcours pédagogiques, Scénarios Serious Game, 
                    Mises à jour incluses, Support utilisateur, Accompagnement prise en main.
                  </p>
                </div>
                ...
                <p>
                  <strong>3.3.</strong> Le paiement s'effectue par carte bancaire via la plateforme sécurisée Stripe. Les moyens de paiement acceptés sont : Visa, Mastercard, American Express, CB et prélèvement SEPA.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-3">
                <p>
                  <strong>5.1.</strong> Conformément à l'article L221-18 du Code de la consommation, le Client consommateur dispose d'un délai de <strong className="text-amber-400">14 jours</strong> à compter de la souscription pour exercer son droit de rétractation, sans avoir à justifier de motifs ni à payer de pénalités.
                </p>
                <p>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg mt-4">
                  <p className="text-amber-400 font-semibold text-sm">📋 Modèle de formulaire de rétractation :</p>
            ...
            {/* Article 6 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 6 - Obligations du Client</h2>
              <div className="space-y-3">
            ...
            {/* Article 7 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 7 - Propriété Intellectuelle</h2>
              <div className="space-y-3">
                <p>
                  <strong>7.1.</strong> L'ensemble des éléments de l'application Aikido@Game (textes, images, vidéos, sons, logiciels, bases de données, marques, logos, parcours pédagogiques, personnages dont Maître Tanaka, design) sont la propriété exclusive de HUMAN KNOWLEDGE ou de ses partenaires.
                </p>
                <p>
            ...
            {/* Article 8 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 8 - Responsabilité et Garanties</h2>
              <div className="space-y-3">
                <p>
                ...
                <p><strong>8.2.</strong> Le Prestataire ne saurait être tenu responsable :</p>
                <ul className="list-disc ml-8 space-y-1">
                ...
                <p className="bg-red-900/20 border border-red-500/30 p-3 rounded-lg">
                  <strong className="text-red-400">⚠️ Important :</strong> L'application Aikido@Game est un outil pédagogique complémentaire et ne remplace en aucun cas l'enseignement dispensé par un professeur qualifié dans un dojo.
                </p>
                <p>
            ...
            {/* Article 9 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 9 - Protection des Données Personnelles</h2>
              <div className="space-y-3">
                <p>
                ...
                <p><strong>9.2.</strong> Les données collectées sont nécessaires à :</p>
                <ul className="list-disc ml-8 space-y-1">
                ...
                <p><strong>9.3.</strong> Le Client dispose des droits suivants sur ses données :</p>
                <ul className="list-disc ml-8 space-y-1">
            ...
            {/* Article 10 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 10 - Données des Mineurs</h2>
              <div className="space-y-3">
                <p>
                ...
                <p>
                  <strong>10.4.</strong> Les parents peuvent suivre la progression de leur enfant via l'espace Parent dédié et valider les activités numériques accomplies.
                </p>
              </div>
            </section>
            ...
            {/* Article 11 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 11 - Force Majeure</h2>
              <div className="space-y-3">
                <p>
            ...
            {/* Article 12 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 12 - Service Client et Réclamations</h2>
              <div className="space-y-3">
                <p><strong>12.1.</strong> Pour toute question ou réclamation, le Client peut contacter le service client :</p>
            ...
            {/* Article 13 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 13 - Médiation et Litiges</h2>
              <div className="space-y-3">
                <p>
            ...
            {/* Article 14 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 14 - Droit Applicable</h2>
              <div className="space-y-3">
                <p>
            ...
            {/* Article 15 */}
            <section>
              <h2 className="text-lg font-semibold text-cyan-400 mb-3">Article 15 - Modification des CGV</h2>
              <div className="space-y-3">
                <p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-700 text-center">
              ...
              <p className="text-xs text-slate-500 mt-4">
                HUMAN KNOWLEDGE - Aikido@Game - Version 2.0 - {lastUpdate}
              </p>
            </div>
          </div>
