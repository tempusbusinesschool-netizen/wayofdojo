...
export default function TechniquesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <TanakaWelcome
        sectionId="techniques-liste"
        sectionTitle={TANAKA_MESSAGES['techniques-liste'].title}
        message={TANAKA_MESSAGES['techniques-liste'].message}
        emoji={TANAKA_MESSAGES['techniques-liste'].emoji}
        variant="full"
      />
