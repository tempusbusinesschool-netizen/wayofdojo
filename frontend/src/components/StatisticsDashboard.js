...
import DojoLogbookDialog from "./DojoLogbookDialog";
  ...
  return (
    <>
      ...
      <div className="mb-4 animate-fadeIn">
        ...
        {/* Progression Dialog - Étape 5 "Progresse" */}
        <ProgressionDialog
          isOpen={showBeltDialog}
          onClose={() => setShowBeltDialog(false)}
          currentBelt={userBelt}
