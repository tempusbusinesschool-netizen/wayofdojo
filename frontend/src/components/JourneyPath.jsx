...
const JOURNEY_STEPS = [
  ...
  },
  {
    ...
    xpReward: 20,
    description: 'Le Dojo Virtuel : jeux numériques, carnet de dojo et suivi de tes validations parentales !',
    ...
    actions: [{ label: 'Entrer dans le Dojo', type: 'navigate', target: 'dojo_virtuel' }],
    tips: ['🎮 Jeux numériques', '🥋 Carnet de dojo', '✅ Validations en attente', '✨ Gagne des points']
  },
  {
    id: 4,
    slug: 'progression',
